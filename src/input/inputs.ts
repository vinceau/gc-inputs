...
type InputList = [boolean,boolean,boolean,boolean,boolean,boolean,boolean,boolean,boolean,boolean,boolean,boolean, number, number, number, number, number, number];
...
export function pollInputs ( gameMode : number, frameByFrame :boolean, controllerInfo : "keyboard" | GamepadInfo
                           , playerSlot : number, controllerIndex : number, keys : {[key: number] :boolean}, playertype : number ) : Input {
...
function pollGamepadInputs( gameMode : number, gamepadInfo : GamepadInfo
                          , playerSlot : number, controllerIndex : number, frameByFrame :boolean ) : Input {
